...
class WorkflowExecutionMetadata:
    ...
    RETURN_TYPES = ("STRING", "STRING", "STRING", "STRING", "STRING", "STRING", "STRING", "LIST")
    RETURN_NAMES = (
        "backend_api_host",
    ...
    def execute(self, json_str: str) -> tuple[str, str, str, str, str, str, str, list[str]]:
